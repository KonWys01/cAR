<script>
	...
	onMount(() => {
		...
		// const targetElement = document.querySelector('#ARScene');

		canvas.appendChild(renderer.domElement); // We should be able to specify an html element to append AR.js related elements to.
